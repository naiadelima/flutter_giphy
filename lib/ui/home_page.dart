...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async{
    ...
    if(_search==null || _search.isEmpty)
      response = await http.get("https://api.giphy.com/v1/gifs/trending?api_key=ijn9rmzOtdKG5NmiYfWVqg5IfKilDyhn&limit=20&rating=G");
    else response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=ijn9rmzOtdKG5NmiYfWVqg5IfKilDyhn&q=$_search&limit=19&offset=$_offSet&rating=G&lang=en");
